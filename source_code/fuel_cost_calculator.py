...
def questions():
  ...
  return mpg, cost, distance


def fuel_cal():
  #Convert input to float
  #mpg = float(mpg)
  mpg, cost, distance = questions()
  ...
  return cost_in_GBP, distance, distance_in_km, mpg, per_litre_for_km

def result():
  cost_in_GBP, distance, distance_in_km, mpg, per_litre_for_km = fuel_cal()
